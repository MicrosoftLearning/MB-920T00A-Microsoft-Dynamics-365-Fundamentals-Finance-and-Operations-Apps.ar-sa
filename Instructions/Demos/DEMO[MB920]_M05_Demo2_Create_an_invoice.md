...
1. في Action Pane، في علامة التبويب **BILL** حدد **Project invoice proposals**. 
...
1. في هذا المثال، تأكد من تعيين **Invoice date** على **2/1/21** و **Start date** على **2/1/21** وend date هو تاريخ اليوم.  
...
1. ضمن علامة تبويب **Project transactions**، حدد **Select all**.

1. حدد "**OK**". 

1. في صفحة **Invoice proposal**، أشر إلى عمود **Invoice line** .  
...
1. حدد علامة تبويب **Parameters**.

1. ضمن **PARAMETER**، قم بتعيين **Posting** إلى **Yes**.

1. ضمن **PRINT OPTIONS**، قم بتعيين **Print invoice** إلى **Yes**.
...
1. في جدول **Active projects**، حدد المشروع **00000093** **Contoso consulting**.

1. في Action Pane، في علامة التبويب **BILL** حدد **Invoice journals**.
...
1. في **Project statements**، أشر إلى قسم **PROJECT DATE**.  
يمكنك إنشاء كشف لأي نطاق زمني تريده.

1. حدد المربع **From** وأدخل **2/1/2021**.
1. 
