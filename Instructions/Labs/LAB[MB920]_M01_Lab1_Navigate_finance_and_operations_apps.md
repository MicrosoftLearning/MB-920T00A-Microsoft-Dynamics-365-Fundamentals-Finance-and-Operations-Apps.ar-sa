...
1. في الصفحة الرئيسية لـ Finance and Operations، سترى:
...
1. ارجع إلى **Default dashboard** باستخدام الارتباط "Finance and Operations" في أعلى اليسار أو أيقونة "الصفحة الرئيسية" في قائمة التنقل اليسرى.

>[!Note] اختصار لوحة المفاتيح: Alt+Shift+Home، يدعم Finance and Operations الكثير من اختصارات لوحة المفاتيح لتسريع الوصول إلى النظام: https://learn.microsoft.com/en-us/dynamics365/fin-ops-core/fin-ops/get-started/shortcut-keys

1. حاول تحديد **Workspace tile**، ثم قم بمراجعة معلومات التعليمات الخاصة بمساحة العمل هذه. عند الاكتمال، ارجع إلى "Default dashboard".
